'use strict'
// <---------------לא להתייחס, זה דף עזר למקרה והקוד נעלם. הוא אפילו לא מחובר--------------------->
const WALL = 'WALL'
const FLOOR = 'FLOOR'
const TARGET = 'TARGET'
const GAMER = 'GAMER'
...
function initGame() {
    ...
    gBoxOnTarget = 2
    gIntervalGold = setInterval(addGold, 6000)
...
function moveTo(i, j) {
    ...
    if ((iAbsDiff === 1 && jAbsDiff === 0) ||
        ...
        if (isOnClock) {
            ...
            gGamerPos.i += 1
            if (gBoard[gGamerPos.i][gGamerPos.j].type === TARGET) gBoxOnTarget--
